(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3185], {
        9897: function(e, t, r) {
            Promise.resolve().then(r.bind(r, 7776)), Promise.resolve().then(r.bind(r, 4802)), Promise.resolve().then(r.t.bind(r, 138, 23))
        },
        6463: function(e, t, r) {
            "use strict";
            r.r(t);
        ...
        `);
                    ...
                    return (0, d.useEffect)(() => {
                        ...
                        let e, t = l(() => {
                            ...
                            s = l(e => {
                                ...
                                if ("_blank" === r.target || "_top" === r.target || "_parent" === r.target || r.hasAttribute("download")) return;
                        ...
                        new MutationObserver(l(() => {
                            Array.from(document.querySelectorAll("a")).filter(e => !(e.href.startsWith("tel:+") || e.href.startsWith("mailto:")) && e.href && "_blank" !== e.target).forEach(e => e.addEventListener("click", s))
            ...
            function y(e) {
                return l(function(t) {
                    return v.default.createElement(v.default.Suspense, null, v.default.createElement(e, { ...t
                    }))
    ...
    function(e) {
        e.O(0, [1261, 7776, 2971, 7023, 1744], function() {
            return e(e.s = 9897)
        }), _N_E = e.O()
    }
]);